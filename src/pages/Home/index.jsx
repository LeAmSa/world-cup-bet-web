  ...
  return (
    <div className="h-screen p-4 bg-red-700 text-white flex flex-col items-center justify-center space-y-6">
      <header className="container flex justify-center max-w-5xl p-4">
        <img className="w-32 md:w-40" src="/logo-bg-wine.svg" />
      </header>
      <div className="container max-w-6xl flex flex-col flex-1 p-4 items-center md:flex-row space-y-6 md:space-y-0 md:space-x-6">
        <div className="md:flex-1 flex justify-center">
          <img className="w-full max-w-[200px] md:max-w-md" src="/photo.png" />
        </div>
        <div className="flex flex-col justify-center flex-1 space-y-4">
          ...
          <a
            href="/signup"
            className="text-red-700 bg-white text-lg px-4 py-3 rounded-xl text-center"
          >
            Criar minha conta
          </a>
          <a
            href="/login"
            className="text-white border border-white text-lg px-4 py-3 rounded-xl text-center"
          >
            Fazer Login
          </a>
        </div>
